  ...
  <div>
    <div class="zeus-search">
      <div class="ivu-row">
        ...
        <Input style="display: inline-block; width: 211px;" v-model="form.spec" size="large" placeholder="规格"></Input>
        <span class="margin-10">到岸目的地：</span>
        <Input style="display: inline-block; width: 211px;" v-model="form.type" size="large"></Input>
        <span class="margin-10">供应商所在地：</span>
        <ZSelect style="display: inline-block; width: 211px;" v-model="form.address" size="large" placeholder="供应商所在地" data="/zues/api/supplier/address" keyValue="address-address"/>
        <span class="margin-10">类别：</span>
        <Input style="display: inline-block; width: 211px;" v-model="form.destination" size="large" placeholder="到岸目的地"></Input>
